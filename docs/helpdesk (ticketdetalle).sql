...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-01-2024 a las 22:58:38
...
(1, 1, 2, 'Te respondo', '2024-01-02 21:11:39', 1),
(2, 1, 1, 'Soy el usuario respondiendo ', '2024-01-02 21:12:14', 1),
(3, 1, 2, 'Para resolver un problema reinicia tu equipo', '2024-01-02 21:12:40', 1),
(4, 1, 1, 'Si con eso se resolvió el problema ', '2024-01-02 21:13:25', 1),
(5, 1, 2, 'Muchas gracias por su confirmación, por favor cerrar el ticket', '2024-01-02 21:14:04', 1);
...
(11, 1, 1, 'test', '<p>fdfdfd</p>', 'Abierto', '2024-01-01 12:23:07', 1),
(12, 1, 3, 'test', '<p>Prueba</p>', 'Abierto', '2024-01-01 12:23:20', 1),
(13, 1, 4, 'PC NO ENCIENDE', '<p>fdfddfdf</p>', 'Abierto', '2024-01-01 12:23:30', 1);
...
--
ALTER TABLE `tm_ticket`
  MODIFY `tick_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
